		...
		<div class="shell">
			...
			<div class="main">
				...
				<section class="slider-section">
					<h2 class="alignleft"><u><h3><strong>Profile Picture Search</strong></h3></u></h2>
					<div class="cl">&nbsp;</div>
...
-->						
						...
						$year = $_POST['year'];
							...
							if($year!="" && $month!="" && $day!="")
							{
								...
								echo "</br><h1><Strong>Photo List :</Strong></br></br></h1>";
								$sql2 = "SELECT image_path FROM Album_Profile_Pictures WHERE year='$year' AND  day='$day' AND month='$month'" ;
								$res2 = $db->query($sql2);
								$i=0;
								while($res = $res2->fetchArray(SQLITE3_ASSOC)){
									...
									//echo "yo";
									$i=$i+1;
									echo '<h1>'.$i.".</h1></br><img src='".$res['image_path']."' alt=''>";
									echo "</br></br></br>";
